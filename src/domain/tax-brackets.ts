...
function noOrdinaryIncomeTaxState(): StateTaxConfig {
  return state([{ rate: 0, label: "0% · No ordinary income tax" }]);
}
...
export const TAX_YEARS: Record<number, TaxYearConfig> = {
  2026: {
    ...
    states: {
      ak: noOrdinaryIncomeTaxState(),
      al: state(brackets([2, "$0"], [4, "$500"], [5, "$3K"])),
      az: state(brackets([2.5, "$0"])),
      ar: state(brackets([0, "$0"], [2, "$5.5K"], [3, "$10.9K"], [3.4, "$15.6K"], [3.9, "$25.7K"]), {
        note: "Arkansas uses a separate lower-income tax-table schedule here (the 2025 thresholds cited by the 2026 source). This estimate does not determine eligibility for the alternate schedule above $92,300 or apply its deductions, credits, or exemptions.",
      }),
      ...
      de: state(brackets([0, "$0"], [2.2, "$2K"], [3.9, "$5K"], [4.8, "$10K"], [5.2, "$20K"], [5.55, "$25K"], [6.6, "$60K"])),
      fl: noOrdinaryIncomeTaxState(),
      ...
      id: state(brackets([0, "$0"], [5.3, "$4.8K"])),
      ...
      ms: state(brackets([0, "$0"], [4, "$10K"])),
      mo: state(brackets([0, "$0"], [2, "$1.35K"], [2.5, "$2.7K"], [3, "$4K"], [3.5, "$5.4K"], [4, "$6.7K"], [4.5, "$8.1K"], [4.7, "$9.4K"])),
      mt: state(brackets([4.7, "$0"], [5.65, "$47.5K"])),
      ne: state(brackets([2.46, "$0"], [3.51, "$4.1K"], [4.55, "$24.8K"])),
      nh: noOrdinaryIncomeTaxState(),
      nj: state([
      ...
      nd: state(brackets([0, "$0"], [1.95, "$48.5K"], [2.5, "$244.8K"])),
      oh: state(brackets([0, "$0"], [2.75, "$26.1K"])),
      ok: state(brackets([0, "$0"], [2.5, "$3.8K"], [3.5, "$4.9K"], [4.5, "$7.2K"])),
      ...
      sd: noOrdinaryIncomeTaxState(),
      tn: noOrdinaryIncomeTaxState(),
      tx: noOrdinaryIncomeTaxState(),
