import { DATA_PATHS, FIDELITY_SOURCES, SCRAPER_USER_AGENT } from "../../data/data-sources";
import type { RateSheetData, TaxData, TaxRule } from "../../data/data-contracts";
import { isMunicipalCategory } from "../../domain/calculations";
...
export async function main(args: readonly string[] = process.argv.slice(2)): Promise<void> {
  ...
  if (args.includes("--help") || args.includes("-h")) {
    console.log("Usage: bun src/scripts/fidelity/scrape-fidelity-mm-tax.ts [--out path]");
    return;
  }
